...
const NOT_FOUND_HINT = '<b>Please note:</b> if multiple orders share this value, only the most recent will be returned.';
...
const SHARED_ADDITIONAL_OPTIONS = [
    {
        displayName: 'Address',
        name: 'Address',
        type: 'string',
    ...
    },
    {
        ...
        type: 'string',
        default: '',
        description: 'JSON array of line items, e.g. [{"GoodsName":"Item A","Quantity":2,"GoodsUnit":"pcs"}]',
        hint: 'Provide as a JSON array',
    },
    {
        displayName: 'Note',
...
exports.orderFields = [
    ...
    },
    {
        ...
        description: 'Delivery or pickup address (required by Track-POD). Cannot be updated once planned into a route.',
    },
    {
        ...
        description: 'Whether to force-update existing Lat/Lon in the Addresses directory from the payload data',
    },
    {
        ...
        description: 'Whether to force-update existing Price in the Goods directory from the payload data',
    },
    {
        ...
        options: SHARED_ADDITIONAL_OPTIONS.filter((o) => !['Address', 'Client'].includes(o.name)),
    },
    // ── Update Order ─────────────────────────────────────────────────────────────
    {
        displayName: 'Force Update Address GPS',
    ...
    },
    {
        ...
        description: 'Provide at least <b>ID</b> or <b>Number</b> to identify which order to update. Only the most recent matching order will be updated.',
